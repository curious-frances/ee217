...
def main():
    if len(sys.argv) < 2:
        print("Usage: python analyze_ppg_part2_fft.py <file.csv> [start_time] [end_time]")
        sys.exit(1)
    ...
    # FFT bandpass for PPG
    lowcut = 1
    highcut = 4.0
    x_clean = fft_bandpass(x, fs, lowcut, highcut)

    # Peak detection settings
    # distance corresponds to maximum plausible HR of 120 BPM
    ...
    # Full cleaned signal with peaks
    ...
    # Zoomed plot from middle of chosen segment
